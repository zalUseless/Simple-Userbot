...
async def _(event):
    ...
    if not (l or l.isdigit()):
        ...
        try:
            ...
            try:
                l = await event.ban_time(l)
            except BaseException:
                return await event.edit( "`Incorrect Format`")
    await event.edit(f"Starting Fake Typing For {l} sec.")
    ...
    if not (l or l.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("`Incorrect Format`")
    await event.edit(f"Starting Fake audio recording For {l} sec.")
    ...
    if not (l or l.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("`Incorrect Format`")
    await event.edit(f"Starting Fake video recording For {l} sec.")
    ...
    if not (l or l.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("`Incorrect Format`")
    await event.edit(f"Starting Fake Game Playing For {l} sec.")
